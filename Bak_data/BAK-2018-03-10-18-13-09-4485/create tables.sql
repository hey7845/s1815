...
CREATE TABLE `xt_bonus` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=40075 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: xt_bonus1 --
...
CREATE TABLE `xt_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=657813 DEFAULT CHARSET=utf8;
-- <fen> --
-- 表的结构: xt_huikui --
...
CREATE TABLE `xt_shouru` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3841 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
-- <fen> --
-- 表的结构: xt_times --
...
CREATE TABLE `xt_zhuanj` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16948 DEFAULT CHARSET=utf8;
-- <fen> --
