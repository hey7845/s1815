...
<thead>
    ...
    <tr class="content_td"  align="center">
      <td>-</td>
      <td>本期</td>
      <td><a href="__URL__/adminFinanceList/sDate/<?php echo ($list4); ?>"><?php echo ($list3['0']); ?></a></td>
      <td>0</td>
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="content_td" align="center">
      ...
      <td><a href="__URL__/adminFinanceList/sDate/<?php echo ($vo['shangqi']); ?>/eDate/<?php echo ($vo['benqi']); ?>"><?php echo ($list1["$i"]['0']); ?></a></td>
      <td><a href="__URL__/adminFinanceTableShow/did/<?php echo ($vo['id']); ?>"><?php echo ($list1["$i"]['1']); ?></a></td>
