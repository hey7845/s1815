...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:30px 0px;">
  <tr>
    <td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0" class="tab4">
      <tr>
        ...
        <td width="20%"><input name="shopid" type="text" id="shopid" value="<?php echo ($shopname); ?>" class="ipt" onKeyUp="guolv(this.name)" onBlur="javascript:yhServer(this.name,'0');" /></td>
        <td width="60%"><div id="shopid1" class="info"><div id="0" class="focus_r"><div class="msg_tip">请填写所属报单中心编号。</div></div></div></td>
      </tr>
      <tr>
        <td width="20%" align="right"><span class="zc_hong">*</span> 推荐人：</td>
        <td width="20%"><input name="RID" id="RID" type="text" value="<?php echo ($rs['user_id']); ?>" class="ipt" onKeyUp="guolv(this.name)"  onBlur="javascript:yhServer(this.name,'1');" /></td>
        <td width="60%"><div id="RID1" class="info"><div id="1" class="focus_r"><div class="msg_tip">请填写推荐人,没有推荐人请填写100000。</div></div></div> </td>
      </tr>
      <!-- 
      <tr>
        <td align="right"><span class="zc_hong">*</span> 接点人：</td>
        <td><input name="FID" id="FID" type="text"  value="" class="ipt" onKeyUp="guolv(this.name)" onBlur="javascript:yhServer(this.name,'2');" /></td>
        <td><div id="FID1" class="info"><div id="2" class="focus_r"><div class="msg_tip">请填写接点人。</div></div></div></td>
      </tr>
       -->
      <tr>
        <td align="right"><span class="zc_hong">*</span> <?php echo ($User_namex); ?>：</td>
        <td>
        <input name="UserID" id="UserID" type="text"  value="" class="ipt" onBlur="javascript:yhServer(this.name,'3');"/>
        </td>
        <td><div id="UserID1" class="info"><div id="3" class="focus_r"><div class="msg_tip">此会员编号用于登录系统使用。</div></div></div></td>
      </tr>
      <tr>
        <td align="right"><span class="zc_hong">*</span> <?php echo ($Nick_namex); ?>：</td>
        <td><input name="nickname" type="text" class="ipt" id="nickname" onKeyUp="javascript:Null_Full(this.name)" maxlength="10"/></td>
      ...
      <tr style="display:none">
        ...
        <td><input name="wenti_dan" type="text" class="ipt"  id="wenti_dan" value="xx" maxlength="255"/></td>
        <td><div id="wenti_dan1" class="info"><div class="focus_r"><div class="msg_tip">输入密保答案。</div></div></div></td>
      </tr>
      <tr>
        <td colspan="3" style="height:5px;"><hr></td>
      </tr>
      ...
      <tr>
        <td align="right"><span class="zc_hong">*</span> <span id="bank_id"><?php if(($bank[0]) == "财付通"): ?>帐号<?php else: ?>银行账号<?php endif; ?></span>：</td>
        <td><input name="BankCard" type="text" class="ipt" id="BankCard" onKeyUp="javascript:Null_Full(this.name)" value="" maxlength="19" /></td>
        <td><div id="BankCard1" class="info"><div id="8" class="focus_r"><div class="msg_tip">请输入账号。</div></div></div></td>
      </tr>
      <tr>
        <td align="right"><span class="zc_hong">*</span> 开户姓名：</td>
        <td><input name="UserName" type="text" class="ipt"  id="UserName" onKeyUp="javascript:Null_Full(this.name)" value="" maxlength="10" /></td>
        <td><div id="UserName1" class="info"><div id="9" class="focus_r"><div class="msg_tip">请输入您的姓名。</div></div></div></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><div id="BankAddress1" class="info"><div id="10" class="focus_r"><div class="msg_tip">请输入您的详细开户地址。</div></div></div></td>
      </tr>
      <script language = JavaScript>
        var s=["s1","s2"];
        var opt0 = ["请选择","请选择"];
      ...
      <tr>
        ...
        <td><input name="UserCode" type="text" class="ipt" id="UserCode" onKeyUp="javascript:Null_Full(this.name)" value="" maxlength="18" /></td>
        <td><div id="UserCode1" class="info"><div id="11" class="focus_r"><div class="msg_tip">请输入您的身份证号。</div></div></div></td>
      </tr>
     <!-- <tr>
        <td align="right">联系地址：</td>
        <td><input name="UserAddress" type="text" class="ipt" id="UserAddress" onFocus="notice('12','')"  onblur="notice('12','none')" onKeyUp="javascript:Null_Full(this.name)" /></td>
      ...
      <tr>
        ...
        <td><input name="UserEmail" type="text" class="ipt"  id="UserEmail" onFocus="notice('15','')"  onblur="notice('15','none')" onKeyUp="javascript:Null_Full(this.name)" value="44@163.com" /></td>
      ...
      <tr>
        ...
        <td><input name="qq" type="text" class="ipt"  id="qq" onKeyUp="javascript:Null_Int(this.name)" value="" /></td>
        <td><div id="qq1" class="info"><div id="16" class="focus_r"><div class="msg_tip">请输入您的 Q Q。</div></div></div></td>
      </tr>
      ...
      <tr>
        ...
        <td><input name="UserTel" type="text" class="ipt"  id="UserTel" onKeyUp="javascript:Null_Full(this.name)" value=""/></td>
        <td><div id="UserTel1" class="info"><div id="13" class="focus_r"><div class="msg_tip">请输入您的联系电话。</div></div></div></td>
      </tr>
       <tr>
