...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
    团队人数：<b><?php echo ($all_nn); ?></b> 人
    </td>
  </tr>
  </form>
 <!-- <?php if(($Mmid) == "1"): ?><form id="form3" name="form3" method="post" action="__URL__/yidongTwo">
  <tr>
    <td>将会员
...
<table width="90%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="30">&nbsp;&nbsp;
    <?php if(is_array($s9)): $i = 0; $__LIST__ = $s9;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$svo): $mod = ($i % 2 );++$i;?><strong><span class="STYLE3"><?php echo ($s10[$key]); ?>(<?php echo ($s9[$key]); ?>)</span></strong>&nbsp;&nbsp;<?php endforeach; endif; else: echo "" ;endif; ?></td>
  </tr>
</table>
<!--<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
